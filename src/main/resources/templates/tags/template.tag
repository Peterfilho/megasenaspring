...
<body>
				...
				<div class="nav-wrapper  light-blue darken-3">
					<div class="container">
						<a class="brand-logo" href="index.jsp"> <img class="utf-logo"
							src="resources/img/quina.png"></img>
								...
								<div class="col s8 offset-s2">
									<div class="center">
										<img class="responsive-img utf-logo-nav"
											src="resources/img/megasena.png" />
									</div>
								</div>
							</div>
	...
	<!-- rodape-->
	<footer class="page-footer l light-blue darken-3">
		<div class="container">
			<div class="row">
				<div class="col s12 center">
					<a href="http://www.utfpr.edu.br/guarapuava"> <img
						src="resources/img/lotericaslogo.png" id="utfpr-footer"
